//===-- YZGPUTargetObjectFile.cpp - YZGPU Object Info -----------------===//
//
...
void YZGPUTargetObjectFile::Initialize(MCContext &Ctx,
...
bool YZGPUTargetObjectFile::isInSmallSection(uint64_t Size) const {
...
// section.
bool YZGPUTargetObjectFile::isGlobalInSmallSection(
...
MCSection *YZGPUTargetObjectFile::SelectSectionForGlobal(
...
void YZGPUTargetObjectFile::getModuleMetadata(Module &M) {
...
bool YZGPUTargetObjectFile::isConstantInSmallSection(const DataLayout &DL,
                                                     const Constant *CN) const {
  return isInSmallSection(DL.getTypeAllocSize(CN->getType()));
}

MCSection *YZGPUTargetObjectFile::getSectionForConstant(
